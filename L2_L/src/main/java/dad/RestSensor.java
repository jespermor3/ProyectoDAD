...
public class RestSensor extends AbstractVerticle {
	...
	public void start(Promise<Void> startFuture) {
		...
		router.get("/api/actuadores").handler(this::getAllWithParamsAc);
		router.get("/api/actuadores").handler(this::getAllAc);
		router.get("/api/actuadores/:id").handler(this::getOneAC);
		router.post("/api/actudores").handler(this::addOneAc);
		router.delete("/api/actuadores/:id").handler(this::deleteOneAc);
		router.put("/api/actuadores/:id").handler(this::putOneAc);
		
		router.route("/api/placas*").handler(BodyHandler.create());
		router.get("/api/placas").handler(this::getAllWithParamsPl);
		router.get("/api/placas").handler(this::getAllPl);
		router.get("/api/placas/:id").handler(this::getOnePl);
		router.post("/api/placas").handler(this::addOnePl);
		router.delete("/api/placas/:id").handler(this::deleteOnePl);
		router.put("/api/placas/:id").handler(this::putOnePl);
	}
